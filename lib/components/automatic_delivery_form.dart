...
class _AutomaticDeliveryFormState extends State<AutomaticDeliveryForm> {
  ...
  final List<String> restaurantes = ['Açaí da Praia', 'Pizzaria do Bairro', 'Hambúrguer Caseiro'];
  
  final TextEditingController _pagamentoController = TextEditingController(text: 'R\$3,00/km');
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text('Perfil de Pagamento', style: TextStyle(fontWeight: FontWeight.w500)),
              SizedBox(height: 8),
              Container(
                decoration: BoxDecoration(
                  borderRadius: BorderRadius.circular(8),
                ...
                children: [
                  Expanded(
                    child: ElevatedButton.icon(
                      ...
                      label: Text('Iniciar Entrega', style: TextStyle(color: Colors.black)),
